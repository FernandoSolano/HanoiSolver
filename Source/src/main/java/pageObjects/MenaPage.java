...
public class MenaPage extends BasePage {
    ...
    private Stack<Disk> tower1;
    private Stack<Disk> tower2;
    private Stack<Disk> tower3;
    ...
    public MenaPage(int disksQuantity) {
        ...
        for (int i = 0; i <= disksQuantity; i++) {
            disks.add(new Disk(i, "//a[img[@src='img/" + i + ".gif']]"));
        }
        for (int i = disksQuantity; i > 0; i--) {
            tower1.push(disks.get(i));
        }
        /*System.out.println("Tamaño de pila: "+tower1.size());
        int towerOriginalSize = tower1.size();
        for (int i=0; i<towerOriginalSize; i++){
            System.out.println("Elemento: "+tower1.pop().getWeight()+" Tamaño de pila: "+tower1.size());
        }*/
    }
    ...
    public void play() {
        ...
        if (disksQuantity % 2 == 0) {
            makeMove(tower1.peek(), tower2_xpath);
            tower2.push(tower1.pop());
        } else {
            makeMove(tower1.peek(), tower3_xpath);
                ...
                if (towerTops[1] != null && towerTops[2] != null && towerTops[3] != null) {
                    ...
                    if (towerTops[1].getWeight() == 1) {
                        ...
                        if (towerTops[2].getWeight() < towerTops[3].getWeight() && towerTops[2].getWeight() % 2 != towerTops[3].getWeight() % 2) {
                            ...
                            makeMove(tower2.peek(), tower3_xpath);
                            ...
                            makeMove(tower3.peek(), tower2_xpath);
                        ...
                        if (towerTops[1].getWeight() < towerTops[3].getWeight() && towerTops[1].getWeight() % 2 != towerTops[3].getWeight() % 2) {
                            ...
                            makeMove(tower3.peek(), tower1_xpath);
                        ...
                        if (towerTops[1].getWeight() < towerTops[2].getWeight() && towerTops[1].getWeight() % 2 != towerTops[2].getWeight() % 2) {
                            ...
                            makeMove(tower2.peek(), tower1_xpath);
    ...
    @Override
    public void makeMove(Disk disk, String tower_xpath) {
        ...
        seleniumUtils.click(By.xpath(disk.getRoute()));
        seleniumUtils.click(By.xpath(tower_xpath));
    }
